 ...
 * 椭圆按键
 */
public class AnjianChangTuoYuanView extends LinearLayout {
    ...
    public AnjianChangTuoYuanView(Context context) {
        super(context,null);
    }

    public AnjianChangTuoYuanView(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
        init(attrs);
    }
    ...
    private void init(AttributeSet attrs) {
        ...
        View contentView = inflate(getContext(), R.layout.view_anjian_changtuoyuan, this);
